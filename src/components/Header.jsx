      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-primary/60 font-sans">Kota's Excellence</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a 
            ...
            className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full border border-primary/10 hover:border-accent hover:text-accent smooth-hover"
          >
            <Phone size={16} />
